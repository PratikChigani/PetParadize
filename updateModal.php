  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> UPDATE PET</h4>
      </div>
...
<div class="col-lg-2">
  ...
  <div class="col-lg-2">
    ...
    <div class="col-lg-10">
      ...
      <input type="number" class="form-control" id="price" name="price" placeholder="<?php echo $price;?>" value="<?php echo $price;?>" required>
  </div></div><br>
  <div class="row">
  <div class="col-lg-2">
  ...
  <div class="col-lg-2">
   ...
   <div class="col-lg-10">
    <img src="<?php echo $image;?>" width="120px;" class="img-responsive img-rounded" style="margin-bottom:5px;">
      ...
      <input type="hidden" class="form-control" id="oladpath" name="oldpath"  value="<?php echo $image;?>" required>
    </div></div>
      </div>
...
if(isset($_POST['savechanges'])){
      ...
      $location = $_POST['oldpath'];
				...
				$sql = ("UPDATE tblcnp set name = '$name',
													   ...
													   price = '$price',
													   image = '$location',
                             class = '$class' WHERE id = '$id'") or die (mysqli_error());
