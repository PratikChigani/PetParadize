...
<title>{PetParadise}-Petshop Online Website</title>
...
<table class="table table-responsive table-hover" style="border: 1px dashed #8c8b8b;
  ...
  <tr style="border: 2px double black; cursor:default;">
    <td style="border: 2px double black;">
      <center><strong class="wow fadeInDown">
          <p style="margin-top:25px;">No.
            <?php echo $count;?>
          </p>
        </strong></center>
    </td>
    <td style="border: 2px double black;">
      <center><img src="<?php echo $row['image']; ?>" width="1000px;" class="img-responsive img-rounded wow fadeInDown">
      </center>
    </td>
    <td style="border: 2px double black;">
    ...
    <td style="border: 2px double black;"><button class="btn btn-success  wow fadeInDown" name="order" type="button"
        style="margin-top:25px;" data-toggle="modal" data-target="#orderModal<?php echo $id;?>"><i
          class="glyphicon glyphicon-shopping-cart"></i> Pet </button></td>
  </tr>
  <!-- Modal -->
        ...
        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="">
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-10">
                <input type="tel" pattern="[7-9]{1}[0-9]{9}" name="contact" class="form-control" required placeholder="Your number">
              </div>
            </div>
            <div class="row">
              <div class="col-lg-2">
              ...
              <div class="col-lg-10">
                <input type="number" name="oqty" min="1" class="form-control" required value="1">
              </div>
            </div>
            <div class="row">
              <div class="col-lg-2">
...
if(isset($_POST['savechanges'])){
    ...
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
				...
				$sql = ("INSERT INTO tblorders(cname, address, contact, cnpoid, oqty, ostatus, otype, datepickup) VALUES('$name','$address','$contact','$id','$qty','new','$otype','$datep')") or die (mysqli_error());
        $result=mysqli_query($con, $sql);
							if($result==true){
								echo '<script>alert("Your order is under process. Our team will contact you soon, thank you!");
