            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Pet <span class="caret"></span></a>
...
<?php include('includes/footer.php');?>
    <!-- <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2022 <a target="_blank" href="#" title="#">Petshop Online Websit</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer> -->
