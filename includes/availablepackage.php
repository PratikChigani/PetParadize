    ...
    <div class="col-md-12" style="border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px;">
        <div class="panel panel-success">
            <div class="panel-heading panel-title" >
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-cog"></i> Add Pet </span>
            </div>
            ...
            <div class="col-lg-6">
            	<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                	<table>
                    	<tr>
                        	<td style="text-align:right; font-weight:bold;">Pet name* : &emsp;</td>
                            <td style="text-align:center;">&emsp; <textarea class="form-control" name="cnpname" required></textarea></td>
                        </tr>
                        <tr>
                        	<td style="text-align:right;font-weight:bold;">Amount(Rs.)* : &emsp;</td>
                            <td style="text-align:center;">&emsp; <input type="number" step="any" class="form-control" name="price" placeholder="0.00" required /></td>
                        </tr>
                        <tr>
                         ...
                         <tr>
                        	<td style="text-align:right;font-weight:bold;">Class* : &emsp;</td>
                            <td style="text-align:center;">&emsp; <select name="class" class="form-control">
                            					<option>Select</option>
...
//
			...
			if(empty($name) || empty($price) || empty($des) || empty($stat)){
					...
					$sql = ("INSERT INTO tblcnp VALUES(NULL,'$name','$price','$des','$location','$stat','$class')") or die (mysql_error());
