            ...
            <div class="panel-body" style="background-color:#fff;">
              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
					...
					// $sql = ("SELECT *  FROM tblcnp  order by id DESC") or die (mysqli_error()); //WHERE class='$class'
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown" style="text-align:justify;"><strong><?php echo $row['description'];?></strong></td>
                            <td class="wow fadeInDown"> <center><strong><?php echo 'Rs.'.$row['price'];?></strong></center></td>
                            <td class="wow fadeInDown"> <center><strong><?php echo $row['status'];?></strong></center></td>
                            <td class="wow fadeInDown"> <center><img src="<?php echo $row['image'];?>" width="1000px;" class="img-responsive img-rounded" /></center></td>
