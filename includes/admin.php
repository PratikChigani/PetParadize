            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa"></i> <u>Orders</u></h4></a>
                </div>
    
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Pet <span class="caret"></span></a>
                        ...
                        <li id="admin" class="wow fadeInDown"><a href="adminacc.php"><span class="glyphicon-user"></span> Admin Account</a></li>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form method="post" action="">
        <div class="modal-body" id="div1">
            ...
            <dt>Price:</dt> <dd><?php echo 'Rs. '.$row['price'];?></dd>
            <dt>Quantity:</dt> <dd><?php echo $row['oqty'];?></dd>
            <dt>Total:</dt> <dd><?php echo 'Rs. '.number_format($total,2,'.',',');?></dd>
            <hr style="border-top: 1px dashed #8c8b8b;
	        border-bottom: 1px dashed #fff;">
    		<h4 ><b>CUSTOMER DETAILS</b></h4>
            <dt>Ordered by:</dt> <dd><?php echo $row['cname'].' ';?></dd>
            <dt>Order Type:</dt> <dd><?php echo $row['otype'].' ';?></dd>
            <dt>Date Pick-up:</dt> <dd><?php echo $row['datepickup'].' ';?></dd>
            <dt>Order Date:</dt> <dd><?php echo $row['timestamp'];?></dd>
...
<?php include('includes/footer.php');?>
    <!-- <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2022 <a target="_blank" href="#" title="#">Petshop Online Website</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer> -->
